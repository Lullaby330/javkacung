...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6310300844:AAGu5-dxkoxR1UfqZvG_wgb4KIWOqpD28rI")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001941036932"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "1850233338"))

#Port
PORT = os.environ.get("PORT", "4339")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://asubang:asubang@cluster0.gbyc7wo.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "kacungj4v")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001618017475"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS",  "1949313751").split()):
        ADMINS.append(int(x))
except ValueError:
